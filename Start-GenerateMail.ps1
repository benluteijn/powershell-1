<#
.SYNOPSIS
Gerneric template used for sending mail.

.DESCRIPTION
This function looks for files in specific directory's generated by existing modules. It then sends them by mail.  
